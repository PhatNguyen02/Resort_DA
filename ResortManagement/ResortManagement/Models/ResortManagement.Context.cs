...
namespace ResortManagement.Models
{
    ...
    public partial class DB_ResortfEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> SearchAvailableRooms(Nullable<System.DateTime> checkIn, Nullable<System.DateTime> checkOut)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("SearchAvailableRooms", checkInParameter, checkOutParameter);
        }
    }
}
